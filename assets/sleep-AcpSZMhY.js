import{R as i,r as c,j as d,c as $}from"./index-DsutIs27.js";var L;(function(e){e[e.UP=-1]="UP",e[e.DOWN=1]="DOWN"})(L||(L={}));function X(e){var t=getComputedStyle(e).overflowY;return e===document.scrollingElement&&t==="visible"?!0:!(t!=="scroll"&&t!=="auto")}function G(e,t){if(!X(e))return!1;if(t===L.DOWN){var s=e.scrollTop+e.clientHeight;return s<e.scrollHeight}if(t===L.UP)return e.scrollTop>0;throw new Error("unsupported direction")}function O(e,t){return G(e,t)?!0:e.parentElement==null?!1:O(e.parentElement,t)}function z(e,t){t===void 0&&(t={});var s=t.insertAt;if(!(!e||typeof document>"u")){var a=document.head||document.getElementsByTagName("head")[0],l=document.createElement("style");l.type="text/css",s==="top"&&a.firstChild?a.insertBefore(l,a.firstChild):a.appendChild(l),l.styleSheet?l.styleSheet.cssText=e:l.appendChild(document.createTextNode(e))}}var J=`.lds-ellipsis {
...
`;z(J);var K=function(){return i.createElement("div",{className:"lds-ellipsis"},i.createElement("div",null),i.createElement("div",null),i.createElement("div",null),i.createElement("div",null))},Q=function(){return i.createElement("div",null,i.createElement("p",null,"↧  pull to refresh  ↧"))},Z=`.ptr,
.ptr__children {
  height: 100%;
  width: 100%;
  overflow: hidden;
