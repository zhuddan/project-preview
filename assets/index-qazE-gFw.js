const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C01o5mnG.js","assets/tabbar-service-BmXoss43.js","assets/index-DEq3JjZo.js","assets/useBaseQuery-BG4KtYfh.js","assets/btn-Kg38c4ZK.js","assets/skeleton-Fuq71roP.js","assets/skeleton-CqACEEbq.css","assets/sleep-DkhfyCAS.js","assets/detail-CuWjuBOu.js","assets/service-DWAdxItz.js","assets/wifi-BFcz0Fmt.js","assets/result-DuvNMw5b.js","assets/home-WHmh22Zm.js","assets/customer-service-CAPoa4XK.js","assets/home-uR27fLFf.css","assets/service-CXvuj55e.js"])))=>i.map(i=>d[i]);
...
}`);var Dr=Array.from({length:4},function(e,t){return"--slab-phase".concat(t+1,"-color")}),u1=function(e){var t,n=Pr(e==null?void 0:e.style,e==null?void 0:e.size),r=n.styles,o=n.fontSize,i=e==null?void 0:e.easing,a=Sr(e==null?void 0:e.speedPlus,"3s").animationPeriod,l=function(s){var u={};if(s instanceof Array){for(var c=Or(s,Dr.length),d=0;d<c.length&&!(d>=4);d++)u[Dr[d]]=c[d];return u}try{if(typeof s!="string")throw new Error("Color String expected");for(var f=0;f<Dr.length;f++)u[Dr[f]]=s}catch(y){for(y instanceof Error?console.warn("[".concat(y.message,']: Received "').concat(typeof s,'" instead with value, ').concat(JSON.stringify(s))):console.warn("".concat(JSON.stringify(s)," received in <Slab /> indicator cannot be processed. Using default instead!")),f=0;f<Dr.length;f++)u[Dr[f]]=Ut}return u}((t=e==null?void 0:e.color)!==null&&t!==void 0?t:"");return M.createElement("span",{className:"rli-d-i-b slab-rli-bounding-box",style:K(K(K(K(K({},o&&{fontSize:o}),a&&{"--rli-animation-duration-unitless":parseFloat(a)}),i&&{"--rli-animation-function":i}),l),r),role:"status","aria-live":"polite","aria-label":"Loading"},M.createElement("span",{className:"rli-d-i-b slab-indicator"},M.createElement("span",{className:"slabs-wrapper"},M.createElement("span",{className:"slab"}),M.createElement("span",{className:"slab"}),M.createElement("span",{className:"slab"}),M.createElement("span",{className:"slab"}))),M.createElement(Er,{staticText:!0,text:e==null?void 0:e.text,textColor:e==null?void 0:e.textColor}))};Ne(`.lifeline-rli-bounding-box {
